...
func run(ctx context.Context, args []string) error {
	...
	if base == "google-cloud-rust" || base == "google-cloud-dart" {
		return runSidekickMigration(abs, *outputPath)
	}
	if base == "google-cloud-python" || base == "google-cloud-go" {
		return runLibrarianMigration(ctx, abs, *outputPath)
	}
