...
This directory contains the design specifications for the `librarian` configuration schema, CLI tooling, automation, and associated workflows.
...
*   **[googleapis.md](./googleapis.md)**: Describes the upstream `googleapis` repository and the role of the central catalog.
