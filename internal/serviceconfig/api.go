...
var APIs = []API{
	...
	{Path: "google/cloud/aiplatform/v1beta1", ServiceConfig: serviceConfigAIPlatformV1Beta1, Languages: []string{LangDart, LangGo, LangPython}},
	{Path: "google/cloud/alloydb/connectors/v1"},
	{Path: "google/cloud/alloydb/connectors/v1alpha", Languages: []string{LangGo, LangPython}},
	{Path: "google/cloud/alloydb/connectors/v1beta", Languages: []string{LangGo, LangPython}},
	...
	{Path: "google/cloud/apigeeregistry/v1", Languages: []string{LangGo, LangPython}},
	...
	{Path: "google/cloud/asset/v1p5beta1", Languages: []string{LangGo, LangPython}},
	...
	{Path: "google/cloud/bigquery/biglake/v1", Languages: []string{LangGo, LangPython}},
	{Path: "google/cloud/bigquery/biglake/v1alpha1", Languages: []string{LangGo, LangPython}},
	{Path: "google/cloud/bigquery/connection/v1"},
	{Path: "google/cloud/bigquery/dataexchange/v1beta1", Languages: []string{LangGo, LangPython}},
	{Path: "google/cloud/bigquery/datapolicies/v1"},
	{Path: "google/cloud/bigquery/datapolicies/v1beta1", Languages: []string{LangGo, LangPython}},
	...
	{Path: "google/cloud/bigquery/migration/v2alpha", Languages: []string{LangGo, LangPython}},
	{Path: "google/cloud/bigquery/reservation/v1"},
	{Path: "google/cloud/bigquery/storage/v1", Languages: []string{LangGo, LangPython}},
	{Path: "google/cloud/bigquery/storage/v1alpha", Languages: []string{LangGo, LangPython}},
	{Path: "google/cloud/bigquery/storage/v1beta", Languages: []string{LangGo, LangPython}},
	{Path: "google/cloud/bigquery/storage/v1beta2", Languages: []string{LangGo, LangPython}},
	{Path: "google/cloud/bigquery/v2"},
	{Path: "google/cloud/billing/budgets/v1", Languages: []string{LangGo, LangPython}},
	{Path: "google/cloud/billing/budgets/v1beta1", Languages: []string{LangGo, LangPython}},
	...
	{Path: "google/cloud/channel/v1", Languages: []string{LangGo, LangPython}},
	...
	{Path: "google/cloud/compute/v1beta", Languages: []string{LangGo, LangPython}},
	...
	{Path: "google/cloud/datacatalog/v1beta1", Languages: []string{LangGo, LangPython}},
	...
	{Path: "google/cloud/datalabeling/v1beta1", Languages: []string{LangGo, LangPython}},
	{Path: "google/cloud/dataplex/v1"},
	{Path: "google/cloud/dataproc/v1"},
	{Path: "google/cloud/dataqna/v1alpha", Languages: []string{LangGo, LangPython}},
	...
	{Path: "google/cloud/gkeconnect/gateway/v1beta1", Languages: []string{LangGo, LangPython}},
	...
	{Path: "google/cloud/mediatranslation/v1beta1", Languages: []string{LangGo, LangPython}},
	...
	{Path: "google/cloud/memorystore/v1beta", Languages: []string{LangGo, LangPython}},
	...
	{Path: "google/cloud/networkconnectivity/v1alpha1", Languages: []string{LangGo, LangPython}},
	...
	{Path: "google/cloud/notebooks/v1", Languages: []string{LangGo, LangPython}},
	{Path: "google/cloud/notebooks/v1beta1", Languages: []string{LangGo, LangPython}},
	...
	{Path: "google/cloud/secretmanager/v1beta2", Languages: []string{LangGo, LangPython}},
	...
	{Path: "google/cloud/tpu/v1", Languages: []string{LangGo, LangPython}},
	...
	{Path: "google/cloud/videointelligence/v1p3beta1", Languages: []string{LangGo, LangPython}},
	{Path: "google/cloud/vision/v1"},
	{Path: "google/cloud/vision/v1p1beta1", Languages: []string{LangGo, LangPython}},
	...
	{Path: "google/cloud/workflows/executions/v1beta", Languages: []string{LangGo, LangPython}},
	...
	{Path: "google/maps/addressvalidation/v1", Languages: []string{LangGo, LangPython}},
	...
	{Path: "google/maps/fleetengine/v1", Languages: []string{LangGo, LangPython}},
	...
	{Path: "google/shopping/type", Languages: []string{LangGo, LangPython}},
