	...
	for _, test := range []struct {
	...
	}{
		{
			...
			want: &API{
				...
				Languages:        []string{config.LanguageDart, config.LanguageGo, config.LanguageJava, config.LanguageNodejs, config.LanguagePython, config.LanguageRust, config.LanguageSwift},
				Title:            "Secret Manager API",
			},
		},
		{
			...
			want: &API{
				...
				Languages:        []string{config.LanguageGo, config.LanguageJava, config.LanguagePython, config.LanguageRust, config.LanguageSwift},
		...
		},
		{
			...
			want: &API{
				...
				Title:              "Vertex AI API",
				Languages:          []string{config.LanguageGo, config.LanguagePython, config.LanguageRust, config.LanguageSwift},
		...
		},
		{
			...
			want: &API{
				...
				Languages:          []string{config.LanguageGo, config.LanguageJava, config.LanguageNodejs, config.LanguagePython, config.LanguageRust, config.LanguageSwift},
