...
//	  -I . \
//	  -I /Users/julieqiu/code/googleapis/googleapis \
//	  grpc_service_config.proto
// versions:
...
var file_grpc_service_config_proto_rawDesc = string([]byte{
	...
	0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x70, 0x69, 0x73, 0x2f, 0x6c, 0x69, 0x62, 0x72,
	0x61, 0x72, 0x69, 0x61, 0x6e, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x63,
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
})

var (
	file_grpc_service_config_proto_rawDescOnce sync.Once
	file_grpc_service_config_proto_rawDescData []byte
)

func file_grpc_service_config_proto_rawDescGZIP() []byte {
	file_grpc_service_config_proto_rawDescOnce.Do(func() {
		file_grpc_service_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_grpc_service_config_proto_rawDesc), len(file_grpc_service_config_proto_rawDesc)))
	})
...
var file_grpc_service_config_proto_goTypes = []any{
...
func file_grpc_service_config_proto_init() {
	...
	file_grpc_service_config_proto_msgTypes[0].OneofWrappers = []any{
		(*MethodConfig_RetryPolicy_)(nil),
		(*MethodConfig_HedgingPolicy_)(nil),
	}
	file_grpc_service_config_proto_msgTypes[5].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_grpc_service_config_proto_rawDesc), len(file_grpc_service_config_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   12,
			NumExtensions: 0,
			NumServices:   0,
