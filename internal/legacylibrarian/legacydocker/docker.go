...
type BuildRequest struct {
	...
	// State is a pointer to the [legacyconfig.LibrarianState] struct, representing
...
type ReleaseStageRequest struct {
	...
	// LibrarianConfig is a pointer to the [legacyconfig.LibrarianConfig] struct, holding
